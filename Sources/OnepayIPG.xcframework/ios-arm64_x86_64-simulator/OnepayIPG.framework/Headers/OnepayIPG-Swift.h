...
#ifndef ONEPAYIPG_SWIFT_H
#define ONEPAYIPG_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OnepayIPG",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///
/// \endcode
SWIFT_CLASS("_TtC9OnepayIPG7Gateway")
...
@interface Gateway (SWIFT_EXTENSION(OnepayIPG)) <NSURLSessionDelegate>
...
SWIFT_CLASS("_TtC9OnepayIPG29Gateway3DSecureViewController")
@interface Gateway3DSecureViewController : UIViewController <WKNavigationDelegate>
...
SWIFT_CLASS("_TtC9OnepayIPG13GatewayMainVC")
@interface GatewayMainVC : UIViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC9OnepayIPG15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(OnepayIPG)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(OnepayIPG)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(OnepayIPG)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(OnepayIPG)) <NSURLSessionTaskDelegate>
